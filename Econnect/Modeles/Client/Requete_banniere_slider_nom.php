<?php
	...
	$req = $bdd->prepare("SELECT maison.Mode_maison FROM utilisateur, maison, user_maison WHERE user_maison.ID_User = utilisateur.ID_User AND user_maison.ID_Maison = maison.ID_Maison AND utilisateur.ID_User = ?");
	$req->bindParam(1, $_SESSION['id']);
	$req->execute();
