<?php
	...
	$req = $bdd->query('SELECT utilisateur.Nom, utilisateur.Prenom FROM utilisateur WHERE utilisateur.ID_User = 2 ');
	...
	$req = $bdd->query('SELECT maison.Mode_maison FROM utilisateur, maison, user_maison WHERE user_maison.ID_User = utilisateur.ID_User AND user_maison.ID_Maison = maison.ID_Maison AND utilisateur.ID_User = 2');
