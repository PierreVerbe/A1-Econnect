<?php
	...
	while ($donnees = $req->fetch())
	{
		...
		<li>Nombre d'utilisateurs secondaires : 2</li>
		<?php
	}

	$req->closeCursor();

	$req2 = $bdd->query('SELECT COUNT(maison.ID_Maison) nbMaison FROM maison, user_maison, utilisateur WHERE maison.ID_Maison = user_maison.ID_Maison AND user_maison.ID_User = utilisateur.ID_User AND utilisateur.Adresse_email = \'pablo.grana@isep.fr\'');
